...
Cuba.define do
  ...
  on "abs_path" do
    res.write view("./test/views/custom/abs_path.hbs", title: "Absolute")
  end
end
...
test "use of absolute path" do
  _, _, body = Cuba.call({ "PATH_INFO" => "/abs_path", "SCRIPT_NAME" => "" })

  assert_response body, ["<title>Absolute</title>\n<h1>Abs Path</h1>\n\n"]
end

test "use of absolute path for the layout" do
  Cuba.settings[:layout] = "./test/views/custom_layout.hbs"
